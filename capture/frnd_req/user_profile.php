...
// CHECK FRIENDS
$is_already_friends = $frnd_obj->is_already_friends($_SESSION['uid'], $user_data->id);
//  IF I AM THE REQUEST SENDER
$check_req_sender = $frnd_obj->am_i_the_req_sender($_SESSION['uid'], $user_data->id);
// IF I AM THE REQUEST RECEIVER
$check_req_receiver = $frnd_obj->am_i_the_req_receiver($_SESSION['uid'], $user_data->id);
// TOTAL REQUESTS
$get_req_num = $frnd_obj->request_notification($_SESSION['uid'], false);
// TOTAL FRIENDS
$get_frnd_num = $frnd_obj->get_all_friends($_SESSION['uid'], false);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="background-color:powderblue;">
    <div class="profile_container">
        ...
        <div class="inner_profile">
            <div class="img">
                <img src="../upload/profile/<?php echo $user_data->user_image; ?>" alt="Profile image">
            </div>
            <h1><?php echo  $user_data->username;?></h1>
            <nav>
            <ul>
                <li><a href="../index.php" rel="noopener noreferrer">Back to Website</a></li>
